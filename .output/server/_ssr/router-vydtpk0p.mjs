...
const appCss = "/assets/styles-CRQyyzzi.css";
...
const $$splitComponentImporter$4 = () => import("./services-DhKRLt4A.mjs");
const Route$4 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Full-service interior design, bespoke furniture, renovation, and art curation by Blue Decor."
    }, {
      property: "og:title",
      content: "Services — Blue Decor"
    }, {
      property: "og:description",
      content: "Full-service interior design, bespoke furniture, and renovation."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./portfolio-DOt3MLiS.mjs");
const Route$3 = createFileRoute("/portfolio")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Portfolio — Blue Decor"
    }, {
      property: "og:description",
      content: "Recent residential and hospitality interiors."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-BCNkxVib.mjs");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Begin a project with Blue Decor. We respond to every inquiry personally within two business days."
    }, {
      property: "og:title",
      content: "Contact — Blue Decor"
    }, {
      property: "og:description",
      content: "Begin a project with Blue Decor."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-DNwBcJ7I.mjs");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "About — Blue Decor"
    }, {
      property: "og:description",
      content: "A focused interior design studio."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BYcajBSK.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Blue Decor is a bespoke interior design studio crafting timeless, layered residential and hospitality interiors."
    }, {
      property: "og:title",
      content: "Blue Decor — Bespoke Interior Design"
    }, {
      property: "og:description",
      content: "Bespoke interiors crafted with quiet confidence."
    }]
  }),
